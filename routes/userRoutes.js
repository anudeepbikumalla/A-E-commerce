...
router.put("/:id", authMiddleware, validateObjectId('id'), checkPermission('manage_own_profile', 'manage_users', 'assign_roles'), userController.updateUser);
router.post("/update-password/:id", authMiddleware, validateObjectId('id'), checkPermission('manage_own_profile', 'manage_users'), userController.simplePasswordUpdate);
